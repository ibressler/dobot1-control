...
class DobotDriver:
    ...
    def EmergencyStop(self):
        ...
        @return True if the command successfully received, False otherwise.
        """
        self._lock.acquire()
    ...
    def GetAccelerometers(self):
        """
        Returns data acquired from accelerometers at power on.
    ...
    def PumpOn(self, on):
        """
        Turn On/Off the pump motor, if you want to actually grip something, you also need to turn the valve on otherwise the air flows through it.
    ...
    def Wait(self, waitTime):
        """
        Makes the arm wait in the current position for the specified period of time. The wait period is specified in seconds and can be fractions of seconds.
        The resolution of this command is up to 20ms.

        To make the arm wait, a number of commands is issued to do nothing. Each command takes 20ms
