...
[maxosprojects](github.com/maxosprojects/open-dobot)).

It's further development of the [DobotSDK package](github.com/maxosprojects/open-dobot/application/python/dobot), adding:
